...
const EditMatterModal = ({ matter, isOpen, onClose }) => {
  const { updateMatter, clients, assets } = useIP();
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    updateMatter(matter.id, formData);
    onClose();
  };
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-gray-900">Edit Legal Matter</h2>
            <button
              onClick={onClose}
