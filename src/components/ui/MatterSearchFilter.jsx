...
const MatterSearchFilter = ({ searchTerm, setSearchTerm, filterType, setFilterType, filterStatus, setFilterStatus, sortBy, setSortBy }) => {
  return (
...
export default MatterSearchFilter;