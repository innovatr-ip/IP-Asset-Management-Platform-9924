...
const EditAssetModal = ({ asset, isOpen, onClose }) => {
  const { updateAsset, clients } = useIP();
  ...
  useEffect(() => {
    if (asset) {
      const countryCode = countries.find(c => c.label === asset.jurisdiction)?.value || 'OTHER';
      setFormData({
        name: asset.name || '',
        type: asset.type || 'patent',
        description: asset.description || '',
        registrationNumber: asset.registrationNumber || '',
        registrationDate: asset.registrationDate || '',
        expiryDate: asset.expiryDate || '',
        country: countryCode,
        customCountry: countryCode === 'OTHER' ? asset.jurisdiction : '',
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-gray-900">Edit IP Asset</h2>
            <button
              onClick={onClose}
